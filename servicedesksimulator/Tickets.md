## Ticket #1: [Customer Support PC is completely dead, agent can't take calls]

**Priority:** High | **Category:** Hardware/Desktop | **Status:** Resolved
...
- Set up a replacement PC using our standard imaging process (SOP-OSD-014): booted it over the network, gave it the right computer name, and let the imaging system install Windows, apps, and join it to the domain automatically.
...
![image alt](https://github.com/InternetCharger/Help-Desk-Ticket-Simulator/blob/dec533b66add4906b0a4c9cacdb47a44b00ad607/Images/pt%201.png)
